...
- содержащий прориС макетом предоставлен `styleguide.psd`, совку состояний элементов интерфейса. При любых расхождениях с макетами он должен иметь наивысший приоритет.
